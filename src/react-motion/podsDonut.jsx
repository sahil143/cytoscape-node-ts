...
import {pie, arc, svg} from 'd3';
import { podColor } from '../data';
...
export default class DonutMotion extends React.PureComponent {
  ...
  render() {
    ...
    const arcFunc = arc().outerRadius(outerRadius).innerRadius(innerRadius).padAngle(.01);
